...
HD_PWD='C:/Users/3408804/Downloads/FPGA1_TP1/TP_PEM/TP_PEM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_CPT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_CPT.tcl
