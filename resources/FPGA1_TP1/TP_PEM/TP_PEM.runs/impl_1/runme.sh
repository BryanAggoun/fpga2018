...
HD_PWD='C:/Users/3408804/Downloads/FPGA1_TP1/TP_PEM/TP_PEM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_CPT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Test_CPT.tcl -notrace
